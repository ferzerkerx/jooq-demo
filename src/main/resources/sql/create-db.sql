...
CREATE TABLE public.artist(artist_id INTEGER GENERATED BY DEFAULT AS IDENTITY,
                    name VARCHAR(100) NOT NULL,
            PRIMARY KEY(artist_id));

CREATE TABLE public.album(album_id INTEGER GENERATED BY DEFAULT AS IDENTITY,
